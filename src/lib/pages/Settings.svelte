<script lang="ts">
  ...
  let userAgent = $state('Gosh-Fetch/1.0');
    ...
    <section class="settings-section">
      ...
      <div class="setting-item">
        <div class="setting-info">
          ...
          <p>Maximum simultaneous downloads (1-20)</p>
        </div>
        <div class="setting-control">
          <input
            type="number"
      ...
      <div class="setting-item">
        <div class="setting-info">
          ...
          <p>Maximum connections per download (1-16)</p>
        </div>
        <div class="setting-control">
          <input
            type="number"
      ...
      <div class="setting-item">
        <div class="setting-info">
          ...
          <p>Number of segments per file (1-64)</p>
        </div>
        <div class="setting-control">
          <input
            type="number"
